          ...
          steps {
            container('maven') {
              ...
              jacoco(execPattern: 'target/jacoco.exec', classPattern: 'target/classes', sourcePattern: 'src/main/java', exclusionPattern: 'src/test*', changeBuildStatus: true, 
                 minimumInstructionCoverage : '30', maximumInstructionCoverage : '99',
                 minimumBranchCoverage : '30', maximumBranchCoverage : '99',
                 minimumComplexityCoverage : '30', maximumComplexityCoverage : '99',
                 minimumLineCoverage : '30', maximumLineCoverage : '99',
                 minimumMethodCoverage : '30', maximumMethodCoverage : '99',
                 minimumClassCoverage : '30', maximumClassCoverage : '99')
            }
          }
        }
