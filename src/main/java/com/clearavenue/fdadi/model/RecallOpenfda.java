...
@JsonPropertyOrder({ "product_ndc", "nui", "package_ndc", "generic_name", "spl_set_id", "pharm_class_cs", "brand_name", "original_packager_product_ndc", "manufacturer_name",
		"pharm_class_pe", "rxcui", "unii", "spl_id", "substance_name", "product_type", "route", "pharm_class_moa", "application_number", "pharm_class_epc", "is_original_packager",
		"upc" })
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class RecallOpenfda {
	...
	@JsonProperty("original_packager_product_ndc")
	@Builder.Default
	public List<String> originalPackagerProductNdc = null;
